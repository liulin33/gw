...
$tit = date('m 月 d 日')." - 柳林工作室";
?>
<!DOCTYPE html>
<!-- saved from http://www.esblog.cn -->
...
<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
	...
	<meta name="author" content="Admin@www.0766city.com" />
	<meta property="og:title" content="毒鸡汤 - 壮士可要来一碗！" />
	<meta property="og:url" content="http://www.iliujin.com/" />
	...
	<div class="row" style="margin-top: 30px;">
	    ...
	    <div class="col">
	    	<div class="float-right" style="padding-top: 0px;">
	    		<a class="btn btn-primary btn-filled btn-xs" href="http://www.iliujin.com/" >爱柳林</a>
	    	</div>
	    </div>
		</div>
</div>
...
<div class="foot-1" style="position: absolute; bottom: 7vh;width: 100%;">
 ...
 <footer>
 <p class="text-center">© 2019 爱柳林 idc All rights reserved</p>
</footer>
</div>
</body>
</html>